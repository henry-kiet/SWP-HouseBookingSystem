            ...
            <div class="hotelWrapper">
                ...
                <div class="hotelImage">
                    <c:forEach items="${listImage}" var="image" >
                        <img src="Images/houseimgs/${image.imglink}" alt="" class="hotelImg" />
                    </c:forEach>
                        ...
                        <div class="hotelDetailsPrice">
                            ...
                            <div class="login-form-container">
                                ...
                                <form action="housepage" method="post">
                                    ...
                                    <h2>Start Date:</h2>  <input class="box" required="" type="date" name="startdate" id="today-date">
...
a = (Account) request.getAttribute("account");
    ...
    document.getElementById("date-today").setAttribute("min", datePattern);
    document.getElementById("date-today").value = datePattern; 
        
        
        document.querySelector('inline-btn').addEventListener('click', (event) => {
