...
<html>
   ...
   <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    ...
    <section class="dashboard">
      ...
      <div class="top3House-containner" style="gap: 3rem;">
                 <div class="title">Top 3 House Booking

      <div class="Housetopcontainner" style="gap: 3rem;">
