...
<!--        <form action="SearchAddServiceServlet" class="search-bar-container"  method="post"  >
        ...
        <button class="fas fa-search" style="height: 60px; font-size: 40px; background-color: #fff" value="search" type="submit"></button>
                ...
                <thead>
                    <tr style="text-align: center" class="border-gray-200" scope="col">
                    <th style="text-align: center" class="border-gray-200" scope="col">Additional_Service_ID</th>
                    <th style="text-align: center" class="border-gray-200" scope="col">Additional_Service_Name</th>
                    <th style="text-align: center" class="border-gray-200" scope="col">Additional_Service_Desc</th>
                    <th style="text-align: center" class="border-gray-200" scope="col">Additional_Service_Price</th>
            ...
            <%
                ...
                %>
                <tr>
                    <td style="text-align: center"><%=a.getServiceid() %></td>
                    <td style="text-align: center"><%=a.getServicename() %></td>
                    <td style="text-align: center"><%=a.getServicedesc() %></td>
                    <td style="text-align: center"><%=a.getServiceprice() %></td>
