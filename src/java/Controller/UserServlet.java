...
//        }
    ...
    protected void viewBill(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            Bill bill = bdao.getBillbyId(billid);
            ...
            h = hdao.getHousebyId(b.getHouseid());
            //List out service
            List<AdditionalService> listAdditionalService = new ArrayList<>();
            HouseAdditionalServiceDAO hasdao = new HouseAdditionalServiceDAO();
            List<HouseAdditionalService> listService = hasdao.getHouseAdditionalServicebyID(b.getHouseid());
            for (HouseAdditionalService houseAdditionalService : listService) {
                ...
                AdditionalService ad = asdao.getAdditionalServicebyID(additionalServiceId);
                listAdditionalService.add(ad);
            }
            if (b != null) {
                request.setAttribute("bill", b);
                request.setAttribute("house", h);
                request.setAttribute("listservice", listAdditionalService);
